...
cmscan --rfam --tblout $outpath/$subject.infernal.tblout --noali --fmt 2 --clanin /home/abharadwaj61/Databases/Rfam.clanin /home/abharadwaj61/Databases/Rfam.cm $inpath
