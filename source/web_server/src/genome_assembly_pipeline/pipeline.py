...
def call_main(i, S, l):
    ...
    #change this
    dir_list = [assembly_dir, qc_output_dir, trimmed_output_dir, multiqc_op_path, trimmed_multiqc_op_path, spades_assembly_dir, spades_assembly_contigs_dir,  spades_quast_dir ]
    if logging_enabled:
